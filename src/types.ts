...
export interface ProjectSettings {
   ...
   * An exact method (Double Integration, Three Moments, Virtual Work, Castigliano) is required to
   * land on the same numbers; a deliberately approximate one (Portal, Cantilever) is required to
   * disclose the gap instead.
   */
  solutionMethod?: 'matrix-stiffness' | 'double-integration' | 'portal-method' | 'cantilever-method' | 'three-moment' | 'virtual-work' | 'castigliano-truss';
