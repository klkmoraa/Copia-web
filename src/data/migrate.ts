...
const normalizeSettings = (input: unknown): ProjectSettings => {
  ...
  const settings: ProjectSettings = {
    ...
    solutionMethod: raw.solutionMethod === undefined
      ...
      : enumAt(raw.solutionMethod, 'settings.solutionMethod', ['matrix-stiffness', 'double-integration', 'portal-method', 'cantilever-method', 'three-moment', 'virtual-work', 'castigliano-truss', 'hardy-cross', 'kani-frame'] as const),
